...
setup(
    name='amo_grid_step',
    version='0.1.0',
    description="AMO Grid generates complex grids for numerical integration",
    long_description=readme + '\n\n' + history,
    author="Paul Saxe",
    author_email='psaxe@vt.edu',
    url='https://github.com/paulsaxe/amo_grid_step',
    packages=find_packages(include=['amo_grid_step']),
    include_package_data=True,
    install_requires=requirements,
    license="BSD license",
    zip_safe=False,
    keywords='amo_grid_step',
    classifiers=[
    ...
    entry_points={
        'org.molssi.workflow': [
            'AMO Grid = amo_grid_step:AMOGridStep',
        ],
